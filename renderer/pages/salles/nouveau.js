...
export default function NouvelleSalle() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetchWithAuth('/api/salles', {
        method: 'POST',
  ...
  return (
    <Layout>
      <div className="max-w-3xl mx-auto">
        ...
        <h1 className="text-3xl font-bold mb-8">Nouvelle Salle</h1>
        ...
        <form onSubmit={handleSubmit} className="bg-white p-8 rounded-lg shadow space-y-6">
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full border rounded px-4 py-2 focus:outline-none focus:border-blue-500"
              placeholder="ex: Projecteur, 20 ordinateurs, Tableau blanc interactif, Climatisation..."
            />
          </div>
